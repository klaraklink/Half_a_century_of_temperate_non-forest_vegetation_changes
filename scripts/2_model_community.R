...
plot_change_lm <- read_csv('results/lm_trends2.csv') |> 
...
plot_change_all3 |> 
  ...
  scale_shape_manual(values = c(17, 16), labels = c('Interval change', 'Linear change'))+
...
ggsave('plots/diversity_lm_int_binomial.png', width = 7, height = 4)
...
ggsave('plots/pca_traits_12.png', width = 8, height = 8)
